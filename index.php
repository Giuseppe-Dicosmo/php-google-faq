...
$frequent_questions = [
  [
    'request' => "<h2>Come state implementando la recente decisione della Corte di giustizia dell'Unione europea (CGUE) relativa al diritto all'oblio?</h2>",
  ...
  [
    'request' => "<h2>Come fa Google a proteggere la mia privacy e a tenere le mie informazioni al sicuro?</h2>",

    'answers' => "<p>Sappiamo che la sicurezza e la privacy sono importanti per te e lo sono anche per noi. Per noi è imperativo offrire un'elevata sicurezza e assicurarti che le tue informazioni sono al sicuro e accessibili quando ne hai bisogno.</p>
  ...
  [
    'request' => "<h2>Perché il mio account è associato a un paese?</h2>",

    'answers' => "<p>Il tuo account è associato a un paese (o territorio) nei Termini di servizio per poter stabilire due cose:</p>
  ...
  [
    'request' => "<h2>Come faccio a rimuovere informazioni su di me dai risultati di ricerca di Google?</h2>",
...
<body>
  ...
  <?php
  foreach ($frequent_questions as $value) {
  ?>
    <main>
      <div class="container">
